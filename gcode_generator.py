...
def generate_master_gcode(placements: List[PlacedPart], settings: Dict) -> str:
    ...
    # IQ ATC dialect: lean boot (G54 only — no G17/G71/G40/G49/G80/G90, no G53),
    # matching the machine's own VECTRIC post output.
    out += [
        "(MASTER JOB - Generated by IQ Pro Layout Tool)",
        f"(Date: {now})",
        f"(Job: {job_name})",
